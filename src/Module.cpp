// wxl-m2: native M2 (MD21/M3) reader + M2 render/compat pipeline, as an out-of-core extension.
// Entry point.
...
int __cdecl WXL_Load(const WXL_Api* api)
{
    ...
    wxl_m2::InstallM2Draw();

    if constexpr (wxl_m2::kEnabled)
    {
        wxl_m2::InstallM2Memory();
        wxl_m2::InstallM2CompatBones();
        wxl_m2::InstallEmitterBlend();
        wxl_m2::InstallM2PerFrameUpdate();
        wxl_m2::InstallM2SceneHitTestSort();
        wxl_m2::InstallM2SetupBatchAlpha();
        wxl_m2::InstallAnimUnwrap();
        wxl_m2::InstallM2CompatLoader();
        wxl_m2::InstallM2Native();
        wxl_m2::InstallModernM2();
    }

    api->Log(WXL_LOG_INFO, "wxl-m2", "native M2 reader active");
    return 1;
}
